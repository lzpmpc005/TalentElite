            ...
            <div className="row row-cols-1 row-cols-md-6 g-auto me-5 ms-5">
                {employees.map(employee => (
                    <div key={employee.id} className="col">
                        ...
                        >
                            {isEditing && editEmployeeId === employee.id ? (
                                <div className="card-body">
                                    <Input
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, first_name: e })}
                                    />
                                    <br /><br />
                                    <Input
                                        type='text'
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, last_name: e })}
                                    />
                                    <br /><br />
                                    <Input
                                        type='text'
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, position: e })}
                                    />
                                    <br /><br />
                                    <Input
                                        type='number'
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, age: e })}
                                    />
                                    <br /><br />
                                    <TextArea
                                        type="text"
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, address: e })}
                                        className="input-description"
                                    />
                                    <br /><br />
                                    <Input
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, email: e })}
                                    />
                                    <br /><br />
                                    <Input
                                        type='tel'
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, phone_number: e })}
                                    />
                                    <br /><br />
                                    <Select
                                        placeholder="Select Department"
                                        ...
                                        onChange={(value) => setEditEmployeeData({ ...editEmployeeData, department: value })}
                                        style={{ width: 120 }}
                                    >
                                        {departments.map(department => (
                                            <Select.Option key={department.id} value={department.id}>{department.name}</Select.Option>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => setEditEmployeeData({ ...editEmployeeData, photo: e })}
                                    />
                                    <br /><br />
                                    <Space>
                                        <Button type="primary" onClick={saveEditEmployee}>Save</Button>
